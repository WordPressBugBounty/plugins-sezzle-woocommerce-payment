 ...
 *
 * The Sezzle checkout class handles the Sezzle checkout process, collecting user data and processing the payment.
 *
 */
 ...
 * Checkout class.
 */
class Sezzle_Checkout {

	/**
	 * The single instance of the class.
	 *
	 * @var Sezzle_Checkout|null
	 */
	 ...
	 * @since 2.1
	 * @static
	 * @return Sezzle_Checkout Main instance
	 */
	...
	protected function update_session( $data ) {
		...
		WC()->session->set( 'posted_data', $data );
